...
sleep 5
cd /bin || exit
wget https://github.com/ARealeza/gestorssh/raw/ntech/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/ARealeza/gestorssh/raw/ntech/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/ARealeza/gestorssh/raw/ntech/gestorssh/checkuser.py > /dev/null 2>&1
